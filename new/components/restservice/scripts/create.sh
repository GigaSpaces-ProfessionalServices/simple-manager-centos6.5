...
CONFIG_INIT_PATH="components/restservice/config/upstart"
...
deploy_blueprint_resource "${CONFIG_INIT_PATH}/cloudify-restservice.conf" "${CONFIG_INIT_DEST}/cloudify-restservice.conf"
